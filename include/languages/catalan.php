...
$login_messages_ar = array(
	...
	"login" => "login", // new
	"username_password_are_required" => "Username and password are required", // new
	"pwd_gen_link" => "create password", // new
	"incorrect_login" => "Usuari o contrasenya incorrectes",
	"pwd_explain_text" =>"Insert a word to be used as password and press <b>Crypt it!</b>.<br> Press <b>Register</b> to write it in the below form", // new
	"pwd_suggest_email_sending"=>"You may want to send yourself a mail to remeber the password", // new
	"pwd_send_link_text" =>"send mail!", // new
	"pwd_encrypt_button_text" => "Cript it!", // new
	"pwd_register_button_text" => "Register password and exit" // new
)
?>